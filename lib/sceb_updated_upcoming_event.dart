...
class ScebUpdatedUpcomingEvent extends StatefulWidget {
  const ScebUpdatedUpcomingEvent({super.key});
  @override
  _ScebUpdatedUpcomingEventState createState() => _ScebUpdatedUpcomingEventState();
}

class _ScebUpdatedUpcomingEventState extends State<ScebUpdatedUpcomingEvent> {
  ...
  void _updateEvent() async {
    ...
    try {
      await FirebaseFirestore.instance.collection('upcoming_events').add(eventData);
